...
public class Bool {
	public static void main(String[] args) {
		...
		//boolean型変数result_1の宣言とaはb以上を表す条件式の代入
		...
		//boolean型変数result_2の宣言とcとdの値は等しくないことを表す条件式を代入
		...
		////boolean型変数result_3の宣言とeは10より大きくfは10未満であることを表す条件式の代入
		...
		//boolean型変数result_4の宣言とgは5以下または10以上であることを表す条件式の代入
